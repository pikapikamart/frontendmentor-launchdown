class Countdown {
    ...
    calculateTime() {
        ...
        const updateNextTime = ()=>{
            // Deduct 1 per property to get the next time
            // used ternary to check if value is < 10, if it is, add 0 to the front
        ...
        const setNewTime = (front, back, next)=>{
            ...
            // set a timeout here so that, it will only update the number
            // after the flipping animation is done
            setTimeout(()=> {
